  ...
  render: function render() {
    ...
    return _react2["default"].createElement(
      ...
      _react2["default"].createElement(
        ...
        fireRef ? [_react2["default"].createElement("div", { key: "1", className: "separator-4-black" }), params.username || userData ? _react2["default"].createElement(_componentsUserUserInfoJsx2["default"], _extends({ key: "2" }, this.props)) : null, _react2["default"].createElement("div", { key: "3", className: "separator-4-black" }), userData || params.username ? _react2["default"].createElement(_componentsUserQuestionsJsx2["default"], _extends({ key: "4" }, this.props)) : null, _react2["default"].createElement("div", { key: "sep-IFollow", className: "separator-4-black" }), _react2["default"].createElement(_componentsUserFollowStreamsJsx2["default"], _extends({ key: "comp-IFollow", follow: "IFollow" }, this.props)), _react2["default"].createElement("div", { key: "sep-followMe", className: "separator-4-black" }), _react2["default"].createElement(_componentsUserFollowStreamsJsx2["default"], _extends({ key: "comp-followMe", follow: "followMe" }, this.props)), _react2["default"].createElement("div", { key: "5", className: "separator-4-black" }), params.username || userData ? _react2["default"].createElement(_componentsUserVideosListingJsx2["default"], _extends({ key: "6", archive: true }, this.props)) : null] : null
      )
    );
  }
});
